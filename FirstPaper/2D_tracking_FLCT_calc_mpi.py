...
if (__name__ == '__main__'):
    ...
    if rank == 0:
        ...
        path = '/scratch/teodor_kostic/ISSI_2D_Slices'
        cube = loaders.load_from_muram_slices(path, 0, 50, 361, 'Bz', 1.0)
...
# Proveriti kako vremensko usrednjavanje utice na rezultate za FWHM